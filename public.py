...
def checkWebConfig(repair_num=3):
    ...
    if web_s == 'nginx':
        ...
        searchStr = "1"
        version_info = "Unknow"
    print_log(result[1], result[1].find('unknown log format "monitor"'))
...
def print_log(*args, _level='DEBUG', color="debug"):
    ...
    log_body = "{}[{}][{}]".format(color_start, format_date(), _level.upper())
    for _info in args:
        try:
            if type(_info) == dict:
...
def get_php_versions(reverse=False):
    ...
    if os.path.exists(_file):
        ...
        version_list = ['52', '53', '54', '55', '56', '70', '71', '72', '73', '74', '80', '81', '82', '83']
